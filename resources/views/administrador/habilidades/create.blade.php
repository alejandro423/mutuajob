...
<div class="max-w-2xl mx-auto">
    ...
    <div class="mb-6">
        ...
        <p class="text-zinc-400 text-sm">
            Registrar una nueva habilidad en el catálogo
        </p>
    ...
    <div class="bg-zinc-950 border border-zinc-800 rounded-2xl p-6">
        ...
        <form action="{{ route('administrador.habilidades.store') }}"
              method="POST">
            ...
            <div class="mb-6">
                ...
                <input
                    ...
                    class="w-full bg-zinc-900 border border-zinc-700 rounded-xl px-4 py-3 text-white focus:outline-none focus:border-red-500"
                    required
                >
            ...
            <div class="flex gap-3">
                ...
                <button
                    type="submit"
                    class="flex-1 bg-red-600 hover:bg-red-700 py-3 rounded-xl font-medium transition">
